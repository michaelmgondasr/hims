...
def show_doctor_details(list_of_doctors):
    doctor_titles = ['Doctor ID', 'Name', 'Age', 'Gender', 'Date of birth (DD-MM-YYYY)',
                     ...
                     'Contact number', 'Alternate contact number', 'nida no',
...
class Doctor:
    ...
    def add_doctor(self):
        ...
        self.nida_no = st.text_input('nida no')
            ...
            with conn:
                c.execute(
                    ...
                    (
                        ...
                        contact_number_2, nida_no, email_id,
                    ...
                    """,
                    {
                        ...
                        'uid': self.nida_no, 'email_id': self.email_id,
